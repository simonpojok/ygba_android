  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '86a2c8f2866dc61628c225ae96f9ae54')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsAgric = new HashMap<String, TableInfo.Column>(60);
        ...
        _columnsAgric.put("quarter", new TableInfo.Column("quarter", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "86a2c8f2866dc61628c225ae96f9ae54", "f8e642282373dd5d88f9666eb1347004");
